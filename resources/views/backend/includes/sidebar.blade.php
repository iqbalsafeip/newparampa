<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <x-utils.link class="c-sidebar-nav-link" :href="route('admin.auth.market.index')" :active="activeClass(Route::is('admin.auth.market'), 'c-active')" icon="c-sidebar-nav-icon cil-speedometer" :text="__('Data Market')" />
        </li>

        <li class="c-sidebar-nav-dropdown {{ activeClass(Route::is('admin.auth.user.*') || Route::is('admin.auth.role.*'), 'c-open c-show') }}">
            <x-utils.link href="#" icon="c-sidebar-nav-icon cil-user" class="c-sidebar-nav-dropdown-toggle" :text="__('Data Master')" />

            <ul class="c-sidebar-nav-dropdown-items">

                <li class="c-sidebar-nav-item">
                    <x-utils.link :href="route('admin.auth.kecamatan.index')" class="c-sidebar-nav-link" :text="__('Kecamatan Management')" :active="activeClass(Route::is('admin.auth.kecamatan.*'), 'c-active')" />
                </li>
            </ul>
        </li>
